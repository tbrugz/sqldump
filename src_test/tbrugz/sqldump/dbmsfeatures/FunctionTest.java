...
public class FunctionTest {
	...
	public void testQuery() throws Exception {
		String[] params = {
				...
				"-Dsqldump.queries=q1, q2, q3",
				"-Dsqldump.query.q1.sql=select count(c1), simple_count(c1) from (select 1 as c1 union all select 1 as c1) a",
				"-Dsqldump.query.q2.sql=select * from information_schema.function_aliases",
				"-Dsqldump.query.q3.sql=select * from information_schema.function_columns",
