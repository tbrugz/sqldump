...
public class StmtExecTest {
	...
	public void doSetupAndLoadData() throws Exception {
		String[] vmparamsRun = {
				"-Dsqlrun.exec.00.file=src_test/tbrugz/sqldump/sqlrun/empdept-drop.sql",
				"-Dsqlrun.exec.01.file=src_test/tbrugz/sqldump/sqlrun/empdept.sql",
				"-Dsqlrun.exec.02.file=src_test/tbrugz/sqldump/sqlrun/empdept-load.sql",
	...
	public void doSetupAndLoadMoreData() throws Exception {
		String[] vmparamsRun = {
				...
				"-Dsqlrun.exec.01.file=src_test/tbrugz/sqldump/sqlrun/empdept.sql",
				"-Dsqlrun.exec.02.file=src_test/tbrugz/sqldump/sqlrun/empdept-load.sql",
				"-Dsqlrun.exec.03.file=src_test/tbrugz/sqldump/sqlrun/empdept-load2.sql",
				"-Dsqlrun.driverclass=org.h2.Driver",
				"-Dsqlrun.dburl=jdbc:h2:"+dbpath,
				"-Dsqlrun.user=h",
				"-Dsqlrun.password=h"
