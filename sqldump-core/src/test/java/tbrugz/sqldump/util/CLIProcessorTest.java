...
public class CLIProcessorTest {
	...
	public void testOneFile() throws IOException {
		String[] args = { CLIProcessor.PARAM_PROPERTIES_FILENAME+"src/test/resources/tbrugz/sqldump/util/p3.properties" };
	...
	public void testTwoFiles() throws IOException {
		String[] args = {
			CLIProcessor.PARAM_PROPERTIES_FILENAME+"src/test/resources/tbrugz/sqldump/util/p3.properties",
			CLIProcessor.PARAM_PROPERTIES_FILENAME+"src/test/resources/tbrugz/sqldump/util/p-xtra.properties"
		};
		Properties p = new Properties();
		CLIProcessor.init("cli", args, "", p);
	...
	public void testDefaultPropFile() throws IOException {
		String[] args = {};
		Properties p = new Properties();
		CLIProcessor.init("cli", args, "src/test/resources/tbrugz/sqldump/util/p3.properties", p);
